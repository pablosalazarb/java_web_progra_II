...
import classes_package.client; //Importamos el paquete creado para manejar clientes y afiliados
...
public class servlet_controller extends HttpServlet {
    ...
    client client_register; //Configuramos un nuevo objeto cliente
    /**
